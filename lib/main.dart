  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      RichText(text: 
         const TextSpan(
          children:[
            ...
            TextSpan(text: '   Shaping "skills" for "scaling" higher...!!!',style: TextStyle(
                color: Colors.redAccent,
                fontSize: 18.7,
                ),),
          ],
      ...
      // Text.rich(
        ...
        //       padding: const EdgeInsets.fromLTRB(20, 300, 5, 0),
        //     child:const Text.rich( TextSpan(text: "Red & White",style: TextStyle(
        //       fontSize: 60,
        //       decoration: TextDecoration.underline,
        //       color: Colors.redAccent,
        //       decorationColor: Colors.redAccent,
        ...
        //       text:"Multimedia Education",style: TextStyle(
        //         color: Colors.redAccent,
        //         fontSize: 25,
        //         ),
        //     ),),
